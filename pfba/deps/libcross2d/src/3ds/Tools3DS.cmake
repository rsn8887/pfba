...
#endif()
set(ENV{DEVKITARM} "/usr/local/devkitpro/devkitARM")
...
if(NOT _3DSXTOOL)
    ...
    find_program(_3DSXTOOL 3dsxtool /usr/local/devkitpro/devkitARM/bin)
    if(_3DSXTOOL)
...
if(NOT SMDHTOOL)
    ...
    find_program(SMDHTOOL smdhtool /usr/local/devkitpro/devkitARM/bin)
    if(SMDHTOOL)
...
if(NOT BANNERTOOL)
    ...
    find_program(BANNERTOOL bannertool /usr/local/devkitpro/devkitARM/bin)
    if(BANNERTOOL)
        message(STATUS "bannertool: ${BANNERTOOL} - found")
    else()
        message(STATUS "bannertool - not found")
    endif()
endif()
...
if(NOT MAKEROM)
    ...
    find_program(MAKEROM makerom /usr/local/devkitpro/devkitARM/bin)
    if(MAKEROM)
        message(STATUS "makerom: ${MAKEROM} - found")
    else()
        message(STATUS "makerom - not found")
    endif()
endif()
...
if(NOT STRIP)
    ...
    find_program(STRIP arm-none-eabi-strip /usr/local/devkitpro/devkitARM/bin)
    if(STRIP)
...
if(NOT BIN2S)
    ...
    find_program(BIN2S bin2s /usr/local/devkitpro/devkitARM/bin)
    if(BIN2S)
...
if(NOT _3DSLINK)
    ...
    find_program(_3DSLINK 3dslink /usr/local/devkitpro/devkitARM/bin)
    if(_3DSLINK)
...
if(NOT PICASSO_EXE)
    ...
    find_program(PICASSO_EXE picasso /usr/local/devkitpro/devkitARM/bin)
    if(PICASSO_EXE)
...
if(NOT NIHSTRO_AS)
    ...
    find_program(NIHSTRO_AS nihstro /usr/local/devkitpro/devkitARM/bin)
    if(NIHSTRO_AS)
