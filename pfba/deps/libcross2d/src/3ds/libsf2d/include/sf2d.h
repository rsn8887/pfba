 ...
 */
#define SF2D_TEMPPOOL_DEFAULT_SIZE 0x40000
 ...
 */
void
sf2d_draw_rectangle_gradient_rotate(int x, int y, int w, int h, u32 color1, u32 color2, sf2d_gradient_dir direction,
                                    float rad);
...
sf2d_texture *
sf2d_create_texture_mem_RGBA8(const void *src_buffer, int src_w, int src_h, sf2d_texfmt pixel_format, sf2d_place place);
